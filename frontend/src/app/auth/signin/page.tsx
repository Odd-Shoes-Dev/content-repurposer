        ...
        >
          ...
          <div className="rounded-2xl p-8 border" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
            ...
            <button
              ...
              className="w-full py-3 rounded-sm text-sm font-medium transition-all flex items-center justify-center gap-2 mb-6 border hover:opacity-80 disabled:opacity-50"
